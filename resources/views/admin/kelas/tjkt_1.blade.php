...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div>
            <h2 class="fw-bold mb-0">Daftar Siswa Kelas X TJKT 1</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.admin_master') }}" class="text-decoration-none">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.users.index') }}" class="text-decoration-none">Manajemen Pengguna</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Kelas X TJKT 1</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-primary text-white py-3">
            <h5 class="mb-0"><i class="mdi mdi-school me-2"></i>Siswa Kelas X TJKT 1</h5>
        </div>
        <div class="card-body">
            @if(session('success'))
            ...
            <div class="table-responsive">
                <table id="students-table" class="table table-hover table-striped" style="width:100%">
                    ...
                    <tbody>
                        {{-- Asumsikan variabel $students dilewatkan dari controller, yang hanya berisi 'siswa' dengan class_name 'X TJKT 1' --}}
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="{{ route('admin.users.edit', $student->id) }}" class="btn btn-sm btn-outline-primary" data-bs-toggle="tooltip" title="Edit Siswa">
                                        <i class="mdi mdi-pencil"></i>
                                    </a>
                                    <form action="{{ route('admin.users.destroy', $student->id) }}" method="POST" class="d-inline delete-form">
                                        @csrf
                                        @method('DELETE')
...
<style>
    /* Add the same styling as in admin.users.index for consistency */
