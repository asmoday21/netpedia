@extends('siswa.siswa_master') {{-- Changed to siswa_master --}}

@section('siswa') {{-- Changed to siswa section --}}
    ...
    <div class="relative w-full py-16 lg:py-20 overflow-hidden rounded-b-4xl shadow-2xl-custom header-bg">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center text-center">
                {{-- Main Welcome Message for Students --}}
                <h1 class="font-extrabold text-white text-4xl sm:text-5xl lg:text-6xl leading-tight mb-3 drop-shadow-lg animate-fade-in-down">
                    ...
                    <div class="mb-6 learning-section-card">
                        ...
                        <div class="flex items-center p-6 lg:p-8 relative overflow-hidden rounded-t-2xl section-header-bg">
                            ...
                            <div class="flex-1">
                                ...
                                {{-- Text reverted for siswa dashboard --}}
                                <p class="text-white/90 text-sm m-0 font-normal">Target kompetensi yang akan kamu capai</p>
                            </div>
                        </div>
                        ...
                        <div class="p-8 bg-white rounded-b-2xl">
                            <div class="flex flex-col lg:flex-row items-center bg-white rounded-xl p-6 shadow-md border border-gray-200 relative overflow-hidden achievement-card-border">
                                ...
                                <div class="flex-1 text-center lg:text-left">
                                    {{-- Text reverted for siswa dashboard --}}
                                    <p class="m-0 text-base leading-relaxed text-gray-700">Pada akhir fase E, kamu mampu memahami prinsip dasar sistem IPV4/IPV6, TCP IP, Networking Service, Sistem Keamanan Jaringan Telekomunikasi, Sistem Seluler, Sistem Microwave, Sistem VSAT IP, Sistem Optik, dan Sistem WLAN.</p>
                                </div>
                                {{-- Font size reverted to original guru version --}}
                    ...
                    <div class="learning-section-card">
                        ...
                        <div class="flex items-center p-6 lg:p-8 relative overflow-hidden rounded-t-2xl section-header-bg-tp">
                            ...
                            <div class="flex-1">
                                ...
                                {{-- Font size reverted to original guru version --}}
                                <p class="text-white/90 text-sm m-0 font-normal">Indikator pencapaian kompetensi yang harus kamu kuasai</p>
                            </div>
                        </div>
                        {{-- Content padding reverted to original guru version --}}
                        <div class="p-8 bg-white rounded-b-2xl">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        @php
                            $cards = [
                                ['title' => 'Materi', 'icon' => 'mdi-book-open-variant', 'color' => 'bg-blue-500', 'route' => route('siswa.materi.index'), 'desc' => 'Lihat materi pembelajaran'],
                                ['title' => 'Tugas', 'icon' => 'mdi-file-send', 'color' => 'bg-yellow-500', 'route' => route('siswa.tugas.index'), 'desc' => 'Kirim tugas yang diberikan'],
                                ['title' => 'Nilai', 'icon' => 'mdi-chart-line', 'color' => 'bg-indigo-500', 'route' => route('siswa.nilai.index'), 'desc' => 'Pantau nilai dan progresmu'],
                                ['title' => 'Quiz', 'icon' => 'mdi-pencil-box-multiple', 'color' => 'bg-green-500', 'route' => route('siswa.quiz.index'), 'desc' => 'Uji pemahamanmu dengan quiz'],
                            ];
                        @endphp
