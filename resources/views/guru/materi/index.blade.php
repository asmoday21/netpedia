            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="material-card" id="material-1" data-material="1">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid">
                          <a href="{{ route('guru.materi.tcp_ip', ['id' => 1]) }}" class="btn btn-material">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="material-card locked-overlay" id="material-2" data-material="2">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid">
                          <a href="{{ route('guru.materi.layanan_jaringan', ['id' => 2]) }}" class="btn btn-material btn-success" onclick="materialSystem.openMaterial(event, 2)" disabled>
                            <i class="bi bi-journal-text me-2"></i> Pelajari Materi
                          </a>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="material-card locked-overlay" id="material-3" data-material="3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid">
                          <a href="{{ route('guru.materi.keamanan_jaringan', ['id' => 3]) }}" class="btn btn-material btn-danger" onclick="materialSystem.openMaterial(event, 3)" disabled>
                            <i class="bi bi-journal-text me-2"></i> Pelajari Materi
                          </a>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="material-card locked-overlay" id="material-4" data-material="4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid">
                          <a href="{{ route('guru.materi.seluler', ['id' => 4]) }}" class="btn btn-material btn-info" onclick="materialSystem.openMaterial(event, 4)" disabled>
                            <i class="bi bi-journal-text me-2"></i> Pelajari Materi
                          </a>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="material-card locked-overlay" id="material-5" data-material="5">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid">
                          <a href="{{ route('guru.materi.optik', ['id' => 5]) }}" class="btn btn-material btn-info" onclick="materialSystem.openMaterial(event, 5)" disabled>
                            <i class="bi bi-journal-text me-2"></i> Pelajari Materi
                          </a>
                        </div>
                    </div>
